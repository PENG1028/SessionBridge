...
registerView('dashboard', {
  ...
  meta: { title: 'Dashboard', icon: Activity, showInSelector: true, launchable: true, launchMode: 'direct', category: 'workspace', sidebarRequirements: { left: 'auto', right: 'auto' } },
});

registerView('logs', {
  component: LogsView,
  meta: { title: 'Logs', icon: List, showInSelector: true, launchable: true, launchMode: 'direct', category: 'workspace', sidebarRequirements: { left: 'auto', right: 'auto' } },
});

registerView('agent-monitor', {
  component: AgentMonitorView,
  meta: { title: 'Agent Monitor', icon: Orbit, showInSelector: true, launchable: true, launchMode: 'direct', category: 'workspace', sidebarRequirements: { left: 'auto', right: 'shown' } },
});
