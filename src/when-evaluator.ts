// ─── When Condition Evaluator (server-safe) ──────────────────
// Lightweight version of the when-condition engine.
// No longer loaded from agent-core/extension-points — the relay
// does not register extension commands, so evaluateWhen always
